    ...
    <I18nProvider>
      <div className="shell min-h-screen py-24">
        ...
        {loading ? (
          ...
          <EmptyState title="No notifications" description="You&apos;ll see new updates here whenever there is an event or message." />
        ) : (
              ...
              <Card key={notification.id} className="rounded-[2rem] border border-hairline-invert">
                <CardHeader>
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <span className={`rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] ${notification.read ? "bg-muted text-muted-foreground" : "bg-primary/10 text-primary"}`}>
