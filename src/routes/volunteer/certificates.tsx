...
import { certificateService } from "@/services/volunteer/certificateService";
    ...
    <AppShell title="Certificates">
      <main className="mx-auto max-w-7xl space-y-8">
        ...
        <header className="space-y-3">
          ...
          <h1 className="display-md">Your volunteer certificates</h1>

          <p className="max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
            Download or preview certificates earned from your completed volunteer events.
          </p>
        </header>
        ...
        {loading && <LoadingState message="Loading your certificates…" />}
        ...
        {!loading && error && (
          <EmptyState title="Unable to load certificates" description={error} />
        )}
                ...
                <CardHeader className="p-6 sm:p-7">
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      ...
                      <CardTitle className="text-xl">{certificate.event_title}</CardTitle>

                      <CardDescription className="mt-2">{certificate.role_name}</CardDescription>
                    </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-border bg-background p-4">
                      <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <p className="text-xs font-medium">Volunteer hours</p>
                      </div>
