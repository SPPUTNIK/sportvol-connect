...
import { scheduleService } from "@/services/volunteer/scheduleService";
    ...
    <AppShell title="Schedule">
      <main className="mx-auto max-w-7xl space-y-8">
        ...
        <header className="space-y-3">
          ...
          <h1 className="display-md">Your upcoming volunteer shifts</h1>

          <p className="max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
            A clear overview of your volunteer shifts, roles, locations and event-day instructions.
          </p>
        </header>
        ...
        {!loading && error && <EmptyState title="Unable to load schedule" description={error} />}
                ...
                <div className="p-6 sm:p-7">
                  <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="shrink-0 rounded-2xl border border-border bg-background px-5 py-4">
                      ...
                      <p className="mt-1 text-sm font-semibold text-foreground">{shift.location}</p>
                    </div>
                  </div>
